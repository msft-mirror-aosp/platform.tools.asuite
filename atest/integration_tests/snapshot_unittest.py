...
class SnapshotTest(unittest.TestCase):
  ...
  def test_take_snapshot_empty_dir_snapshot_is_created(self):
    ...
    self.assertTrue(self.temp_dir.joinpath("db/test_metadata.json").exists())
  ...
  def test_take_snapshot_with_include_and_exclude_paths(self):
    ...
    snapshot.take_snapshot(
        "test", workspace, include_paths=["dir1"], exclude_paths=["dir1/file1"]
    )
  ...
  def test_restore_snapshot_with_modified_files(self):
    ...
    self.assertTrue(workspace.joinpath("dir1", "file1").read_text(), "test1")
